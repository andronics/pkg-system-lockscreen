# lockscreen - AI Assistant Instructions

**Package**: `@system/lockscreen`
**Version**: 0.1.0
**Type**: system package

## Package Overview

**Description**: Lockscreen Manager - Screen locking and idle control

**Purpose**: Provide lockscreen manager - screen locking and idle control functionality for the pkgs ecosystem.
...
**Executables**:
- `.local/bin/lockscreen` - Main executable
- `.local/bin/lockscreen.phase4.backup` - Main executable
...
1. **Test installation**: `stow lockscreen`
2. **Test functionality**: Run main commands and verify output
3. **Test uninstallation**: `stow -D lockscreen`
